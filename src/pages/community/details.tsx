        ...
        <>
            ...
            <div className="mt-5 mx-auto lg:w[1600px] md:w-[1000px] w-[300px] box-border">
                ...
                <form>
                    ...
                    <div className="flex items-center py-4 rounded-lg bg-gray-50 dark:bg-gray-700">
                        <div className="w-full">
                            <span className="text-white font-semibold p-4">안녕하세요 </span>
                            <textarea id="chat" className="resize-none block ml-2 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
                        </div>
                        <button type="submit" className="ml-2 inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 dark:text-blue-500 dark:hover:bg-gray-600">
